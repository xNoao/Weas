/* v2.574: promoted Edit/Gallery/Palette bridge.
   Keeps the LAB visual shell in sync with the original page logic. */
(function(){
  'use strict';
  ...
  function bindGalleryGlow(){
    ...
    grid.addEventListener('click', event => {
      ...
      // Reflow intentionally restarts the short 1.2s glow.
