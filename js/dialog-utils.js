...
(function(){
  ...
  function close(result){
    ...
    const dialogClasses = Array.isArray(overlay.__dialogClasses) ? overlay.__dialogClasses : [];
    dialogClasses.forEach(cls => cls && overlay.classList.remove(cls));
    overlay.__dialogClasses = [];
  ...
  function showDialog(options = {}){
    ...
    const previousDialogClasses = Array.isArray(overlay.__dialogClasses) ? overlay.__dialogClasses : [];
    previousDialogClasses.forEach(cls => cls && overlay.classList.remove(cls));
    const dialogClasses = String(options.dialogClass || '')
      .split(/\s+/)
      .map(cls => cls.trim())
      .filter(Boolean);
    dialogClasses.forEach(cls => overlay.classList.add(cls));
    overlay.__dialogClasses = dialogClasses;
