/* Mudae Organizer Rebuild storage module.
   Owns localStorage IO and JSON downloads.

   This module is intentionally dependency-light. The app passes payload builders
   and normalizers in, so storage does not need direct access to app internals.
*/
(function(){
  'use strict';
