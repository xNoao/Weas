/* Mudae Organizer Rebuild performance module.
   Central switch for optional performance optimizations.
   Defaults ON. Disable from console:
   MUDAE_PERF.disable()
   MUDAE_PERF.enable()
   MUDAE_PERF.toggle()
   MUDAE_PERF.disableGifControl()
   MUDAE_PERF.enableGifControl()
*/
(function(){
  'use strict';
