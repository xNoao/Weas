...
(function(){
  ...
  function startLoad(img){
    ...
    // GIF controller can re-scan if needed, but this module does not own GIF logic.
  ...
  function releaseVisible(root = document, options = {}){
    ...
    // forcing the whole harem at once. This makes the first scrolls after
    // "Loading harem" feel ready instead of catching up card by card.
