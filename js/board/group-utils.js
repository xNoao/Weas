/* Mudae Organizer Rebuild group utilities.
   Keeps group metadata, legacy import helpers and group naming logic out of app.js.
*/
(function(){
  'use strict';
  ...
  function create(context){
    ...
    function moveGroupMember(groupId, characterId, direction){
      ...
      // v2.293:
      // The lead is locked at the top of the group. Other members cannot move
      // above it, and the lead itself cannot be moved down/up by the order arrows.
      ...
      // Ensure lead remains first even after any edge-case reorder.
    ...
    function moveGroupMemberToIndex(groupId, characterId, targetIndex){
      ...
      // Lead remains locked at top. Other members cannot be moved above index 1.
      if (leadId && charId === leadId) return false;
